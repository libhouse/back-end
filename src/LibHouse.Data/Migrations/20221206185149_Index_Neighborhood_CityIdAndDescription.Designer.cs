...
namespace LibHouse.Data.Migrations
{
    ...
    [Migration("20221206185149_Index_Neighborhood_CityIdAndDescription")]
    partial class Index_Neighborhood_CityIdAndDescription
    {
            ...
            modelBuilder.Entity("LibHouse.Business.Entities.Localizations.City", b =>
                {
                    ...
                    b.HasIndex("FederativeUnitId", "Name")
                        .IsUnique()
                        .HasDatabaseName("idx_city_federativeunitid_description");
