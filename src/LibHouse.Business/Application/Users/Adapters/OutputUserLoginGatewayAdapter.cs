...
{
    internal static class OutputUserLoginGatewayAdapter
    {
        internal static OutputUserLogin AdaptUsing(this OutputUserLoginGateway output, LoggedUser userLoginData) =>
            new(
                isSuccess: true,
